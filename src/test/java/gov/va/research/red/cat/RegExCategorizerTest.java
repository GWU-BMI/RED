...
public class RegExCategorizerTest {
	...
	public void testExtractClassifier(){
		...
		try {
			...
			noLabels.add("no");
			Map<String, Collection<RegEx>> retMap = crex.findRegexesAndSaveInFile(new File(CLASSIFIER_TEST_URI), yesLabels, noLabels);
	...
	public void testConfidenceMeasurer() throws IOException{
		...
		regExCategorizer.findRegexesAndSaveInFile(vttFile, yesLabels, noLabels);
	}
